...
_Generated: 2026-07-02T19:23:31.806761+00:00_

This view lists the businesses whose `discovery_source_types` includes `google_places`
.

- records: **29** of 1752 canonical

| business_name | vertical | city | state | score | mockup_priority | pack | readiness | next_action |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Arlington AC & Heating | hvac | Arlington | TX | 70 | build_after_review | yes | needs_enrichment | save_for_later_review |
| Spencer Air Conditioning & Heating | hvac | Irving | TX | 70 | build_after_review | yes | needs_enrichment | save_for_later_review |
...
| Garland Heating & Air Conditioning | hvac | Garland | TX | 35 | do_not_pitch | no | needs_enrichment | no_outreach_default |
| Cool Kings Heating and Air | unknown | Baton Rouge | LA | 30 | do_not_pitch | no | needs_enrichment | no_outreach_default |
